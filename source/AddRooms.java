...
public class AddRooms extends JFrame implements ActionListener{
    ...
    AddRooms(){
       ...
       heading.setFont(new Font("Tahoma",Font.BOLD, 18));
        ...
        JLabel lblrooms = new JLabel("Rooms Numbers");
        ...
        String availableOption[] = {"Select","Available","Occupied"};
        ...
        String cleanOption[] = {"Select","Clean","Dirty"};
        ...
        String bedtypeOption[] = {"Select","Single Bed","Double Bed","Queen Size","King Size"};
        typecombo = new JComboBox(bedtypeOption);
        ...
        cancel = new JButton("Cancel Rooms");
